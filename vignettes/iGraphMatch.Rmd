...
(start_convex <- start_rds)
# init_start(start = "convex", nns = nns, ns = ns, soft_seeds = bad_soft_seeds, 
...
match_nss_convex <- match_nss_rds # graph_match_FW(g1, g2, seeds, start = "convex")
```
...
start_convex <- start_rds #init_start(start = "convex", nns = nns, ns = ns, soft_seeds = good_soft_seeds, 
                           # A = g1, B = g2, seeds = seeds)
