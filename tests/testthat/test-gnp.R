...
test_that("number of edges", {
  expect_equal(length(E(g$graph1)),52)
  expect_equal(length(E(g$graph2)),52)
})
test_that("degree of vertex in each graph", {
  expect_equal(degree(g$graph1),c(11,9,7,9,10,13,11,9,13,12))
  expect_equal(degree(g$graph2),c(9,9,13,11,12,7,10,9,13,11)) 
})
...
test_that("number of edges", {
  expect_equal(length(E(g$graph1)),51)
  expect_equal(length(E(g$graph2)),54)
})
test_that("degree of vertex in each graph", {
  expect_equal(degree(g$graph1),c(10,12,10,7,11,11,8,14,11,8))
  expect_equal(degree(g$graph2),c(5,12,8,12,14,14,13,10,9,11)) 
})
