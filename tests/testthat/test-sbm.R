...
test_that("number of edges", {
  expect_equal(length(E(g$graph1)),2)
  expect_equal(length(E(g$graph2)),2)
})
test_that("degree of vertex in each graph", {
  expect_equal(degree(g$graph1),c(0,0,0,1,1,2,0,0,0,0))
  expect_equal(degree(g$graph2),c(0,0,0,1,1,1,0,0,0,1)) 
})
...
test_that("number of vertices", {
  expect_equal(length(V(g1$graph1)),10) 
  expect_equal(length(V(g1$graph2)),10)
})
test_that("number of edges", {
  expect_equal(length(E(g1$graph1)),2)
  expect_equal(length(E(g1$graph2)),1)
})
test_that("degree of vertex in each graph", {
  expect_equal(degree(g1$graph1),c(0,0,1,0,1,0,0,0,0,2))
  expect_equal(degree(g1$graph2),c(0,0,1,0,0,0,0,0,0,1)) 
})
