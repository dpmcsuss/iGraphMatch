...
#'   "convex", "PATH", "percolation", "IsoRank", "Umeyama", "sinkhorn", or a
#'   user-defined graph matching function. Please check Details and Examples
#'   sections for instructions on how to define your own function.
